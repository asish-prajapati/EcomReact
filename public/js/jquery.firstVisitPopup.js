 ...
 */
    ...
    function validatpopupemail() {
        ...
        if (!pattern1.test($('#email-popup').val())) {
         ...
         $('.banner').before('<div className="alert alert-success"><i className="fa fa-check-circle"></i>Subscription Success<button type="button" className="close" data-dismiss="alert">&times;</button></div>');
            return false;
        }
    }
(function ($) {
