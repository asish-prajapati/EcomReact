          ...
          <div className="panel-heading">
            <h4 className="panel-title">
              <a
                ...
                href="#collapseOne"
              >
                Step 1: Checkout Options <i className="fa fa-caret-down"></i>
              </a>
            </h4>
          </div>
            ...
            <div className="panel-body">
              <div className="row">
                <div className="col-sm-6">
                  ...
                  <div className="radio">
                    <label>
                      <input type="radio" value="guest" name="account" /> Guest
                      Checkout
                    </label>
                  </div>
                  <p>
                ...
                <div className="col-sm-6">
                  ...
                  <div className="form-group">
                    <label for="input-email" className="control-label">
                      E-Mail
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="form-group">
                    <label for="input-password" className="control-label">
                      Password
                    </label>
                    <input
                      type="password"
                ...
                <div id="payment-existing">
                  <select className="form-control" name="address_id">
                    <option selected="selected" value="4">
                      dasd, adsasd, Al Hasakah, Syrian Arab Republic
                    </option>
                  </select>
                </div>
                <div className="radio">
                ...
                <div id="payment-new" style={{ display: "none" }}>
                  ...
                  <div className="form-group required">
                    ...
                    <div className="col-sm-10">
                      ...
                      >
                        ...
                        <option selected="selected" value="205">
                  ...
                  <div className="form-group required">
                    ...
                    <div className="col-sm-10">
                      ...
                      >
                        <option value=""> --- Please Select --- </option>
                        <option selected="selected" value="3121">
                          Al Hasakah
                        </option>
            ...
            <div className="panel-body">
              <form className="form-horizontal">
                ...
                <div id="shipping-existing">
                  <select className="form-control" name="address_id">
                    <option selected="selected" value="4">
                      adsasd, Al Hasakah, Syrian Arab Republic
                    </option>
                  </select>
                </div>
                <div className="radio">
                  <label>
                    <input type="radio" value="new" name="shipping_address" /> I
                    want to use a new address
                  </label>
                </div>
                <br />
                  ...
                  <tbody>
                    <tr>
                      <td className="text-left">
                        <a href="http://localhost/opc001/index.php?route=product/product&amp;product_id=46">
                          Sony VAIO
                        </a>
                      </td>
