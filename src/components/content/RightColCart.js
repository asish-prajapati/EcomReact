        ...
        <div className="panel panel-default pull-left">
          ...
          <div id="collapseOne" className="panel-collapse collapse in">
            <div className="panel-body">
              <label for="input-coupon" className="col-sm-4 control-label">
          ...
          <div className="panel-heading">
            <h4 className="panel-title">
              ...
              <a
                ...
                href="#collapseTwo"
              >
                Use Gift Voucher <i className="fa fa-caret-down"></i>
              </a>{" "}
            </h4>
          </div>
          <div id="collapseTwo" className="panel-collapse collapse">
            <div className="panel-body">
              <label for="input-voucher" className="col-sm-4 control-label">
            ...
            <div className="panel-body">
              ...
              <form className="form-horizontal">
                <div className="form-group required">
                  <label for="input-country" className="col-sm-2 control-label">
                    Country
                  </label>
                ...
                <div className="form-group required">
                  <label for="input-zone" className="col-sm-2 control-label">
                    Region / State
                  </label>
                  <div className="col-sm-10">
                    <select
