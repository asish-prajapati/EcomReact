        ...
        <div className="blog-item listing-effect col-md-12 mb_50">
          ...
          <div className="post-info mtb_20 ">
            ...
            <p>
              ...
              facilis tempora ab Lorem ipsum dolor sit amet, consectetur
              adipisicing elit. Repudiandae provident minus similique porro
              assumenda illo dolore ducimus vero ipsum illum ipsa velit,
              deleniti accusantium repellat facilis tempora ab Lorem ipsum dolor
              sit amet, consectetur adipisicing elit. Repudiandae provident
              minus similique porro assumenda illo dolore ducimus vero ipsum
              illum ipsa velit, deleniti accusantium repellat facilis tempora ab
              Lorem ipsum dolor sit amet, consectetur adipisicing elit.
              Repudiandae provident minus similique porro assumenda illo dolore
              ducimus vero ipsum illum ipsa velit, deleniti accusantium repellat
              facilis tempora ab
          ...
          <blockquote>
            ...
            malesuada ut. Praesent lacus erat, ultricies ut risus nec,
            pellentesque interdum purus. In mi justo, consectetur tincidunt
            sapien eget, venenatis volutpat risus. Maecenas eget pretium eros.
            Integer tincidunt aliquet ligula in vulputate. Ut ut justo
            facilisis, vulputate augue vel, vestibulum tortor. Nullam varius
            lacus non porttitor sodales. Vivamus ultricies est vitae pharetra
            convallis. Sed suscipit, nisi sit amet tempus mollis, mauris ante
            tempor risu
          </blockquote>
          ...
          consectetur adipisicing elit. Repudiandae provident minus similique
          porro assumenda illo dolore ducimus vero ipsum illum ipsa velit,
          deleniti accusantium repellat facilis tempora ab Lorem ipsum dolor sit
          amet, consectet
          ...
          <div className="author-about mt_50">
            ...
            <div className="author mtb_30">
              ...
              <div className="author-body">
                ...
                <div className="author-content mt_10">
                  Vivamus imperdiet ex sed lobortis luctus. Aenean posuere nulla
                  in turluctus. Aenean posuere nulla in tur pis porttitor
                  laoreet. Quisque finibus aliquet purus. Ut et mi eu ante
                  interdum .
                </div>
              </div>
            </div>
          ...
          <div id="comments" className="comments-area mt_50">
                ...
                <article className="comment-body mtb_30">
                  ...
                  <div className="comment-main">
                    ...
                    <div className="comment-content mt_10">
                      ...
                      turluctus. Aenean posuere nulla in turs porttitor larpis
                      porttitor larpis porttitor lauctus. Aenean posuere nulla
                      in turpis porttitor laoreet. Quisque finibus aliquet
                      purus.
                    </div>
                  </div>
                </article>
                    ...
                    <article className="comment-body mtb_30">
                      ...
                      <div className="comment-main">
                        ...
                        <div className="comment-content mt_10">
                          ...
                          euismod faucibus dolor a finibus.Maecenas euismod
                          faucibus dolor a finibus.Maecenas euismod faucibus
                          dolor a finibus.cenas euismod faucibus dolor a
                          finibus.
                        </div>
                      </div>
                    </article>
                ...
                <article className="comment-body mtb_30">
                  ...
                  <div className="comment-main">
                    ...
                    <div className="comment-content mt_10">
                      ...
                      nulla in turpis porttitor laoreet. Quisque finibus aliquet
                      purus. Ut et mi eu ante interdum dignissim pellentesque a
                      mi.
                    </div>
                  </div>
                </article>
            ...
            <div className="leave-form">
              <h3 className="comment-title mt_50 mb_30" id="reply-title">
                Leave A Comment
              </h3>
              {/* <!-- Comment Form --> */}
